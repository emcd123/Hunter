...
namespace TestSandbox
{
    public static class TestSandbox
    {
        ...
        private static readonly int _titleWidth = 80;
        private static readonly int _titleHeight = 11;
        private static RLConsole _inventoryConsole;

        private static readonly int _subMenuWidth = 40;
        private static readonly int _subMenuHeight = 10;
        ...
        public static void Main()
        {
            ...
            _inventoryConsole = new RLConsole(_titleWidth, _titleHeight);
        ...
        private static void OnRootConsoleRender(object sender, UpdateEventArgs e)
        {
            ...
            RLConsole.Blit(_subMenuConsole, 0, 0, _subMenuWidth, _subMenuHeight, _rootConsole, 0, _inventoryHeight);
